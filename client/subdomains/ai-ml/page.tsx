              ...
              <>
                ...
                <form onSubmit={handleSubmit} className="space-y-3">
                  ...
                  <div className="flex items-start gap-2 pt-1 text-left">
                    <input type="checkbox" id="aiMlConsent" required defaultChecked className="mt-1 h-3.5 w-3.5 rounded border-slate-300 text-[#7c3aed]" />
                    <label htmlFor="aiMlConsent" className="text-[11px] text-slate-500 leading-tight">
        ...
        <div className="w-[min(1200px,94%)] mx-auto space-y-6">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pb-6 border-b border-white/10">
            <div>
              ...
              <p className="text-xs text-slate-400 mt-1">AI &amp; Machine Learning Specialization</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-[11px] text-[#8899bb] leading-relaxed">
            ...
            <div>
              ...
              <p>Inxyme is an independent professional learning institute. TensorFlow, PyTorch, and Python are registered trademarks of their respective foundations. Indicative salary numbers represent industry estimates and do not guarantee employment or salary outcomes.</p>
            </div>
          </div>
