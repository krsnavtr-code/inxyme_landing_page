      ...
      <footer className="bg-[#0a1a3a] text-[#8899bb] py-12 text-xs">
        <div className="w-[min(1200px,94%)] mx-auto space-y-6">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pb-6 border-b border-white/10">
            <div>
              <span className="text-2xl font-black tracking-tight"><span className="text-[#0066ff]">IN</span><span className="text-[#ff6a00]">X</span><span className="text-[#0066ff]">YME</span></span>
