            ...
            {status === "success" ? (
              ...
              <>
                ...
                <form onSubmit={handleSubmit} className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <select name="state" required defaultValue="" className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#059669] text-slate-600">
                    ...
                    <select name="qualification" required defaultValue="" className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#059669] text-slate-600">
                      <option value="" disabled>Qualification *</option>
                      {["10+2","B.Tech / B.E.","BCA / B.Sc IT","B.Sc / Science","Graduate","Working Professional","Other"].map(q => <option key={q}>{q}</option>)}
                    </select>
                  </div>
      ...
      <footer className="bg-[#0a1a3a] text-[#8899bb] py-10 text-xs">
        <div className="w-[min(1200px,94%)] mx-auto space-y-4">
          ...
          <p className="text-[11px] leading-relaxed text-[#667085]">
            <strong className="text-slate-400">Disclaimer:</strong> Inxyme is an independent e-learning platform offering job-ready certification courses. Salary ranges are indicative market data. Placement support is provided on best-effort basis. Individual outcomes may vary based on skills and market conditions.
          </p>
